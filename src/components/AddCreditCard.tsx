    ...
    <div className="px-3 flex-col items-center justify-center w-[43%] rounded-lg border border-neutral-600 ml-4">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className='flex justify-between items-center gap-5 px-8 py-3'>
          <button className="w-40 h-9 p-2 bg-blue-400 rounded-lg flex-col justify-center items-center inline-flex text-white text-xl 
          font-medium font-['Inter']" type="submit">Adicionar</button>
          <Link href="/dashboard/user/credit_card" className="w-40 h-9 p-2 bg-white rounded-lg border border-blue-400 flex-col justify-center items-center inline-flex
           text-blue-400 text-xl font-medium font-['Inter']" type="button">Cancelar</Link>
        </div>
